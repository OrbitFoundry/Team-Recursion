      ...
      {stats && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-4 mb-8">
            ...
            <StatCard label="Total Applications" value={stats.totalApplied} bgClass="bg-[#dceeb1] text-black" textClass="text-black/70" />
            <StatCard label="Active Pipelines" value={stats.totalActive} bgClass="bg-[#f4ecd6] text-black" textClass="text-black/70" />
            <StatCard label="Offers / Selected" value={stats.totalOffers} bgClass="bg-[#c8e6cd] text-black" textClass="text-black/70" />
            <StatCard
              label="Success Rate"
              value={`${stats.successRate}%`}
              sub={`Rejected: ${stats.totalRejected}`}
                    ...
                    >
                      <div className="min-w-0 pr-3">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 truncate font-mono">
                          {app.role} · <span className="font-semibold text-black dark:text-gray-200">{app.studentName || 'Student'}</span>
                        </div>
                      </div>
