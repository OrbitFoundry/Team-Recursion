              ...
              >
                ...
                <div className="p-6 bg-[#0c0b10] space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-xs font-mono uppercase tracking-widest text-[#c5b0f4] font-bold">PLACEMENT SYSTEM</div>
                      <div className="text-lg font-bold text-white font-sans">Applications &amp; Deadlines</div>
                    </div>
